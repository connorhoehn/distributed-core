...
import { EntityUpdate } from "../../../persistence/types";
export { EntityUpdate };
...
export interface CheckpointEntityState extends EntityRecord {
...
export interface EntitySnapshot {
  timestamp: number;
  version: number;
  entities: Record<string, CheckpointEntityState>;
  nodeId: string;
  lsn?: number; // Add lsn if used in your checkpoint logic
}
