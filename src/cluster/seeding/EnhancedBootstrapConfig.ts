...
export interface EnhancedBootstrapOptions {
...
/**
 * Enhanced BootstrapConfig with structured seed node management
 */
export class EnhancedBootstrapConfig extends EventEmitter {
  ...
  constructor(options: EnhancedBootstrapOptions = {}) {
    super();
   ...
   */
  static create(options: EnhancedBootstrapOptions = {}): EnhancedBootstrapConfig {
    return new EnhancedBootstrapConfig(options);
  }

  /**
   * Create from legacy BootstrapConfig
   */
  static fromLegacy(legacyConfig: BootstrapConfig): EnhancedBootstrapConfig {
    return new EnhancedBootstrapConfig({
