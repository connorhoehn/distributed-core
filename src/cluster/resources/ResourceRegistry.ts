...
import { InMemoryEntityRegistry } from '../entity/InMemoryEntityRegistry';
import { EntityRecord } from '../entity/types';
import { 
  ResourceMetadata, 
...
import { ResourceTopologyManager } from '../topology/ResourceTopologyManager';
import { StateDelta } from '../delta-sync/StateDelta';
import { ClusterManager } from '../ClusterManager';
import { ResourceQueryEngine } from './ResourceQueryEngine';
import { ResourceSubscriptionManager } from './ResourceSubscriptionManager';
import { ResourceLifecycleEventSystem } from './ResourceLifecycleEventSystem';
import { DistributedSemanticsConfig, DistributedSemanticsFlags, globalSemanticsConfig } from './DistributedSemanticsConfig';
...
} from './DistributedOperationsConfig';
...
export class ResourceRegistry extends EventEmitter {
  ...
  private initializeEnhancedComponents(): void {
    ...
    try {
      ...
      this.queryEngine = new ResourceQueryEngine(this, this.clusterManager, {
      ...
      this.monitoringSystem = new ResourceMonitoringSystem(this, this.clusterManager, {
